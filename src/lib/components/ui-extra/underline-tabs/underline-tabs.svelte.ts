...
class UnderlineTabsTriggerState {
  ...
  onmouseenter(
    e: Parameters<NonNullable<TabsPrimitive.TriggerProps['onmouseenter']>>[0]
  ) {
    this.handleFocus();
  ...
  onmouseleave(
    e: Parameters<NonNullable<TabsPrimitive.TriggerProps['onmouseleave']>>[0]
  ) {
    this.handleBlur();
  ...
  onfocus(
    e: Parameters<NonNullable<TabsPrimitive.TriggerProps['onfocus']>>[0]
  ) {
    this.handleFocus();
