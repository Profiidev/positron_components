<script lang="ts">
  ...
  import { useFileDropZoneTrigger } from '$lib/components/ui-extra/file-drop-zone/file-drop-zone.svelte.js';
  import { displaySize } from '$lib/components/ui-extra/file-drop-zone/index.js';
  import type { FileDropZoneTriggerProps } from '$lib/components/ui-extra/file-drop-zone/types.js';
