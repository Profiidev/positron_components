...
<script lang="ts">
  import CountrySelector from '$lib/components/ui-extra/phone-input/country-selector.svelte';
  import { type PhoneInputProps } from '$lib/components/ui-extra/phone-input';
