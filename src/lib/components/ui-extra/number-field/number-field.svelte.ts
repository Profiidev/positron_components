...
export class NumberFieldButton {
  ...
  onpointerdown(
    e: Parameters<NonNullable<ButtonElementProps['onpointerdown']>>[0]
  ) {
    this.increment();
  ...
  onpointerup(
    e: Parameters<NonNullable<ButtonElementProps['onpointerup']>>[0]
  ) {
  ...
  onpointerleave(
    e: Parameters<NonNullable<ButtonElementProps['onpointerleave']>>[0]
  ) {
  ...
  onpointercancel(
    e: Parameters<NonNullable<ButtonElementProps['onpointercancel']>>[0]
  ) {
    this.rampState.reset();
